...
4. Select compatibility for Firefox and next the button "Sign Add-On".
5. Select the option "No" to source code distribution.
6. Go back to the developer hub and select the add-on that should now appear in th e"My Add-ons" section.
7. Select the option "Manage Status & Versions".
8. If the status is approved, click on the version number and download the .xpi file to install the generated add-on.
